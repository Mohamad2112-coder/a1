...
<head>
	<meta charset="UTF-8">
	<title><?php echo $post_title; ?> Planting Tree</title>
...
<body>
	...
	<div class="blog">
		...
		<nav class="navbar navbar-expand-md navbar-light bg-dark">
		  <a class="navbar-brand" href="#"><i class="fas fa-laptop-code"></i>  Mobile shop website</a>
			...
			<div>
				<div class="row">
					<div class="col-md-8 title">
						...
						<p class="lead-para">- <a href="http://www.alphacode.co.in">News</a></p>
					</div>
				</div>
			</div>
